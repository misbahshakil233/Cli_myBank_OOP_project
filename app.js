...
const wellcome = chalkAnimation.rainbow("welcome guyzz to my bank project .....💰💵");
await sleep();
wellcome.stop();
class Customer {
    firstName;
    ...
    do {
        ...
        if (service.select === "View Balance") {
            ...
            if (account) {
                ...
                console.log(`DEAR ${chalk.bold.blueBright(name?.firstName)} ${chalk.bold.blueBright(name?.lastName)} Your Account Balance is ${account.balance}💰💵`);
            }
            ;
        }
        ;
        if (service.select === "Cash Withdraw") {
            ...
            if (account) {
                ...
                if (amount.rupees > account.balance) {
                    console.log(chalk.bold.blueBright("Insuficient Balance"));
                }
